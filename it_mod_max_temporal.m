...
function [gamma, omega, beta, S, Q, converged] = ...
  ...
  if uniform  
    ...
    while ~converged && iter < max_iter
      ...
      [B, twom] = multiord(A, gamma, omega);  % ordinal interlayer coupling
      if strcmp(algtype, '')
      ...
      % Keep iterating if there is chance of convergence
      %if iter == max_iter && K <= 5
      %  max_iter = min(max_iter + 8, 16);
      %end
